...
<div class="container" id="page">
	<div id="header">
		<h1 style="color: white; font-size:25px ; margin-bottom:0em; border-bottom-style: none; padding: 10px;">Test Case K-24 IT Academy</h1>
	</div><!-- header -->
    <!--
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Member', 'url'=>array('/member'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest)
			),
		)); ?>
	</div> <!--mainmenu -->
